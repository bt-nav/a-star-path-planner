...
The GUI provided by the AERO60492 instructors for testing path_planner.py

Authors: Dr Kieran Wood, Dr Pawel Ladosz
Date: March 2026
"""
...
import path_planner as pathPlanner
...
class MainWindow(QMainWindow):
    ...
    def draw_control_panel(self, parentLayout):
        ...
        self.width_input = LabelledIntField(
            "Width", 2, self.grid_dimensions[0]
        )
        self.height_input = LabelledIntField(
            "Height", 2, self.grid_dimensions[1]
        )
